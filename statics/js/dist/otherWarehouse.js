...
//					})
			...
			if (e.id > 0) {
				...
				this.$_toolBottom.html("edit" === e.status ? '<a id="add" class="ui-btn ui-btn-sp mrb">新增</a><a id="edit" class="ui-btn mrb">保存</a><a href="#"  id="print"  rel="'+ e.id +'" class="ui-btn">打印</a>' : '<a id="add" class="ui-btn ui-btn-sp mrb">新增</a><a href="#"  id="print"  rel="'+ e.id +'" class="ui-btn">打印</a><a class="ui-btn-prev mrb" id="prev" title="上一张"><b></b></a><a class="ui-btn-next" id="next" title="下一张"><b></b></a>');
