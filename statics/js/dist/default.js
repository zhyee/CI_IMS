...
//function BBSPop() {
//	var e = $("#yswb-tab"),
//		t = ['<ul id="yswbPop">', '<li class="yswbPop-title">请选择您要进入的论坛</li>', '<li><strong>产品服务论坛</strong><p>在线会计，在线进销存操作问题咨询</p><a href="http://www.xxx.com/042633" target="_blank">进入论坛>></a></li>', '<li><strong>会计交流论坛</strong><p>会计实操，会计学习，会计资讯</p><a href="http://www.com/wwww.com/026606" target="_blank">进入论坛>></a></li>', "</ul>"].join("");
...
//}
//function getStores() {
//	SYSTEM.isAdmin || SYSTEM.rights.CLOUDSTORE_QUERY ? Public.ajaxGet("http://wd.xxxxx
...
//	SYSTEM.isAdmin || SYSTEM.rights.EXPRESS_QUERY ? Public.ajaxGet("http://wd.xxxx.com/bs/express.do?action=list", {}, function(e) {
...
function(e) {
	if (2 === SYSTEM.siVersion && SYSTEM.isOpen) {
		var t, i = location.protocol + "//" + location.host + "/",
			a = '您的单据分录已经录入达到300条，继续使用选择<a href="http://www.xxxxx.com/buy/invoicing/" target="_blank">购买产品</a>或者完善个人信息赠送1000条免费容量。';
		if (SYSTEM.isshortUser) {
			if (SYSTEM.isshortUser) {
				//t = "?updateUrl=" + encodeURIComponent(i) + "&warning=" + encodeURIComponent(a) + "&loginPage=http://www.xxxxx.com/buy/invoicing/";
//				e.dialog({
//					min: !1,
//					max: !1,
//					cancle: !1,
...
//				})
			...
			//t = "?updateUrl=" + encodeURIComponent(i) + "&warning=" + encodeURIComponent(a);
//			e.dialog({
//				min: !1,
//				max: !1,
//				cancle: !1,
